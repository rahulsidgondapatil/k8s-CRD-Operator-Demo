...
import (
	...
	customcontrollerv1alpha1 "github.com/rahulsidgondapatil/sample-customController/pkg/apis/customcontroller/v1alpha1"
	...
	v1alpha1 "github.com/rahulsidgondapatil/sample-customController/pkg/client/listers/customcontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CustomcontrollerV1alpha1().DepSvcResources(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CustomcontrollerV1alpha1().DepSvcResources(namespace).Watch(options)
			},
		},
		&customcontrollerv1alpha1.DepSvcResource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *depSvcResourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&customcontrollerv1alpha1.DepSvcResource{}, f.defaultInformer)
}
